 ...
 * Des:
 */
public class AndroidAdapter extends BaseQuickAdapter<GankBean.GankItem, BaseViewHolder> {

    public AndroidAdapter(@Nullable List<GankBean.GankItem> data) {
        super(R.layout.gank_item_category_card, data);
    }
