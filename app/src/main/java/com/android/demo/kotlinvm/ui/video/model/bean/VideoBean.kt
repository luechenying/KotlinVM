package com.android.demo.kotlinvm.ui.video.model.bean

import com.chad.library.adapter.base.entity.MultiItemEntity
import java.io.Serializable

/**
 * @see com.android.demo.kotlinvm.ui.main.model.bean.HomeBean
 * 因为不知道有多少种Tpye，所以除了HomeBean需要重新弄了个bean，实际开发不需要这么麻烦。。。
 */
data class VideoBean(val issueList: ArrayList<Issue>, val nextPageUrl: String, val nextPublishTime: Long, val newestIssueType: String, val dialog: Any) {
