...
import kotlinx.android.synthetic.main.base_recyclerview_fragment.*

/**
 * Des: 上下拉通用Fragment类
 */
abstract class BaseRvListFragment<VM : BaseListViewModel, DATA> : BaseViewModelFragment<VM>() {
    ...
    override fun getLayoutId(): Int = R.layout.base_recyclerview_fragment
